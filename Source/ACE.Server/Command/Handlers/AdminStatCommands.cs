...
namespace ACE.Server.Command.Handlers
{
    public static class AdminStatCommands
    {
        ...
        public static void HandleServerStatus(Session session, params string[] parameters)
        {
            ...
            sb.Append($"{NetworkManager.GetSessionCount():N0} connections, {NetworkManager.GetUniqueSessionEndpointCount():N0} unique connections, {PlayerManager.GetActualOnlineCount():N0} players online{'\n'}");
            sb.Append($"Total Accounts Created: {DatabaseManager.Authentication.GetAccountCount():N0}, Total Characters Created: {(PlayerManager.GetOfflineCount() + PlayerManager.GetActualOnlineCount()):N0}{'\n'}");
